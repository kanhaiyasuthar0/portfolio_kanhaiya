...
import photo from "../../kanhaiya/kandy1.jpg"
		...
		<div ref={scrollRef}>
			...
			>
				...
				>
					...
					<h1>
						I am a Full Stack Developer based in Mumbai. I build
						things for web.
					</h1>
					<div className={styles.btn}>
						
						<a href='https://drive.google.com/drive/folders/1A9R08opylAMJpANTtzbB1CxQjEqrVI5s?usp=sharing' target='_blank' rel='noopener noreferrer'>
							<Button
								text={
